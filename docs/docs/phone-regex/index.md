...
|------|---------------------------------|------------------------------|-------------------|-------------------------------|
| AR   | RX_PHONE_AR                     | /^(?:\+54\|0)?(11\|[1-9][1-9])\d{8}$/ | +541122345678     | Argentina phone number format  |
| AU   | RX_PHONE_AU                     | /^(?:\+61\|0)[2-478](?:[ -]?[0-9]){8}$/ | +61412345678      | Australia phone number format  |
| BR   | RX_PHONE_BR                     | /^(?:\+55\|0)[1-9][1-9][0-9]{8,9}$/ | +55123456789      | Brazil phone number format     |
| CA   | RX_PHONE_CA                     | /^(?:\+1[-.●]?)?\(?([2-9][0-8][0-9])\)?[-.●]?([2-9][0-9]{2})[-.●]?([0-9]{4})$/ | +1-234-567-8901   | Canada phone number format     |
| CN   | RX_PHONE_CN                     | /^(?:\+86)?1[3-9][0-9]{9}$/ | +8612345678901    | China phone number format      |
| EG   | RX_PHONE_EG                     | /^(?:\+20\|0)?1[0125]\d{8}$/ | +201234567890    | Egypt phone number format      |
| FR   | RX_PHONE_FR                     | /^(?:\+33\|0)[1-9](?:[ .-]?[0-9]{2}){4}$/ | +33123456789     | France phone number format     |
| DE   | RX_PHONE_DE                     | /^(?:\+49\|0)[1-9][0-9]{1,4}[ -]?[0-9]{3,14}$/ | +4912345678901   | Germany phone number format    |
| IN   | RX_PHONE_IN                     | /^(?:\+91\|0)?[6-9][0-9]{9}$/ | +911234567890    | India phone number format      |
| ID   | RX_PHONE_ID                     | /^(?:\+62\|0)[2-9]\d{7,11}$/ | +6212345678901   | Indonesia phone number format  |
| IT   | RX_PHONE_IT                     | /^(?:\+39)?\s?3[1-9]\d{8}$/ | +393123456789    | Italy phone number format      |
| JP   | RX_PHONE_JP                     | /^(?:\+81\|0)[6-9]0[0-9]{8}$/ | +8190123456789  | Japan phone number format      |
| MX   | RX_PHONE_MX                     | /^(?:\+52)?(1)?\s?\d{10}$/ | +521234567890   | Mexico phone number format     |
| NG   | RX_PHONE_NG                     | /^(?:\+234\|0)?[789]\d{9}$/ | +2348123456789  | Nigeria phone number format    |
| RU   | RX_PHONE_RU                     | /^(?:\+7\|8)?[489][0-9]{9,10}$/ | +79123456789    | Russia phone number format     |
| SA   | RX_PHONE_SA                     | /^(?:\+966\|0)?5\d{8}$/ | +966512345678   | Saudi Arabia phone number format |
| ZA   | RX_PHONE_ZA                     | /^(?:\+27\|0)[6-8][0-9]{8}$/ | +27812345678    | South Africa phone number format |
| KR   | RX_PHONE_KR                     | /^(?:\+82\|0)?1[0-9]{9,10}$/ | +8210123456789 | South Korea phone number format |
| ES   | RX_PHONE_ES                     | /^(?:\+34)?\s?(6\d{1}\|7[1-9])\d{7}$/ | +34612345678   | Spain phone number format      |
| TR   | RX_PHONE_TR                     | /^(?:\+90\|0)?5\d{9}$/ | +905123456789   | Turkey phone number format     |
| UK   | RX_PHONE_UK                     | /^(?:\+44\|0)7\d{9}$/ | +447123456789   | UK phone number format         |
| US   | RX_PHONE_US                     | /^(?:\+1[-.●]?)?\(?([2-9][0-8][0-9])\)?[-.●]?([2-9][0-9]{2})[-.●]?([0-9]{4})$/ | +1-234-567-8901 | US phone number format         |
| AF   | RX_PHONE_AF                     | /^(?:\+93\|0)?[7-9]\d{8}$/ | +93712345678    | Afghanistan phone number format |
| AL   | RX_PHONE_AL                     | /^(?:\+355\|0)?6\d{8}$/ | +35561234567    | Albania phone number format    |
| DZ   | RX_PHONE_DZ                     | /^(?:\+213\|0)?[5-7]\d{8}$/ | +213612345678  | Algeria phone number format    |
| AD   | RX_PHONE_AD                     | /^(?:\+376)?\d{6}$/ | +376123456     | Andorra phone number format    |
| AO   | RX_PHONE_AO                     | /^(?:\+244)?[29]\d{7,8}$/ | +244912345678  | Angola phone number format     |
| AG   | RX_PHONE_AG                     | /^(?:\+1-268)?[0-9]{7}$/ | +1-2681234567 | Antigua and Barbuda phone number format |
| AM   | RX_PHONE_AM                     | /^(?:\+374\|0)?(77\|99\|55\|98\|44)\d{6}$/ | +37477123456  | Armenia phone number format    |
...
| GQ   | RX_PHONE_GQ                     | /^(?:\+240)?[222-229]\d{6}$/ | +240222123456 | Equatorial Guinea phone number format |
...
| LY   | RX_PHONE_LY                     | /^(?:\+218\|0)?9\d{7,9}$/ | +218912345678 | Libya phone number format      |
...
| PH   | RX_PHONE_PH                     | /^(?:\+63\|0)?9[0-9]\d{7,8}$/ | +639123456789 | Philippines phone number format |
...
| UG   | RX_PHONE_UG                     | /^(?:\+256\|0)?[7-9]\d{8}$/ | +256712345678 | Uganda phone number format     |
