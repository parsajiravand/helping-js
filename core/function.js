...
exports.resolveValueOrGetter = resolveValueOrGetter;
...
function resolveValueOrGetter(valueOrGetter) {
  for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    args[_key - 1] = arguments[_key];
  }
  return typeof valueOrGetter === 'function' ? valueOrGetter.apply(void 0, args) : valueOrGetter;
}
function executeWithCount(fn, count) {
  var n = 0;
  return function () {
...
function watchChange(getValue, fn) {
...
function applyFinally(fn, onFinally) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _context.n = 3;
          return resolveValueOrGetter(onFinally);
        case 3:
          return _context.f(2);
        case 4:
          return _context.a(2);
...
function joinFunctionsByResult() {
  ...
  return function () {
    ...
    for (var i = 0; i < fns.length; i++) {
      r = fns[i].apply(fns, arguments);
    }
    return r;
  };
}
function joinFunctionsByNext() {
...
function mapObjectTree(obj, mapper) {
  ...
  var _walk = function walk(o) {
    if (o == null || _typeof(o) !== 'object') return o;
